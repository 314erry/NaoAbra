...
function unlockLogin() {
    ...
    } else if (password == "eusouachave") { document.getElementById("hint2").style.display = "flex"; }
    else { document.getElementById("hint").style.display = "flex"; }
...
function unlock2(file2) {
    ...
    if (passwordPrompt == "carta" || passwordPrompt == "Carta") {
        ...
        document.getElementById("file2").innerHTML =
            `<a target="_blank" href=\"FilesHTML/file_02/02.html\" style="cursor: pointer" onclick="files2()">
        <img src=\"img/pasta.png\" style="width: 150px; height: 110px; margin-bottom: 5px;">
...
function unlock3(file3) {
    ...
    if (passwordPrompt == "") {
        ...
        document.getElementById("file3").innerHTML =
            `<a target="_blank" href=\"FilesHTML/file_03/03.html\" style="cursor: pointer" onclick="files3()">
        <img src=\"img/pasta.png\" style="width: 150px; height: 110px;">
...
function unlock4(file4) {
    ...
    if (passwordPrompt == "") {
        ...
        document.getElementById("file4").innerHTML =
            `<a target="_blank" href=\"FilesHTML/file_04/04.html\" style="cursor: pointer" onclick="files4()">
        <img src=\"img/pasta.png\" style="width: 150px; height: 110px;">
        <figcaption>08/06/2019</figcaption>
